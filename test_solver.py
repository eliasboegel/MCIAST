...
class TestSolver(unittest.TestCase):
    ...
    def test_initialize_params_correct(self):
        ...
        self.assertEqual(params.y_in.all(), np.asarray([0.2, 0.8]).all())
        ...
        self.assertEqual(params.p_partial_in.all(), np.asarray([1, 4]).all())
        self.assertEqual(params.kl, 12)
        self.assertEqual(params.disp, 2)
        ...
        self.assertEqual(params.p_total.all(), np.asarray([5, 4.9, 4.8, 4.7, 4.6, 4.5, 4.4, 4.3, 4.2, 4.1, 4.0]).all())
